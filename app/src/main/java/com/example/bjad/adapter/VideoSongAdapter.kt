...
import com.example.bjad.databinding.VideoListViewBinding
...
class VideoSongAdapter(
    ...
    class MyHolder(binding:VideoListViewBinding):RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        return MyHolder(VideoListViewBinding.inflate(LayoutInflater.from(context),parent,false))
    }
